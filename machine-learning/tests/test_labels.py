...
def test_base_label_from_hba1c_needs_only_hba1c():
    assert base_label_from_hba1c(5.0) == RiskCategory.LOW
    assert base_label_from_hba1c(6.0) == RiskCategory.MEDIUM
    assert base_label_from_hba1c(7.0) == RiskCategory.HIGH
